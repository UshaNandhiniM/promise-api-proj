  ...
  .then((result) => {
    ...
    for (let i = 0; i < result.length; i++) {
      ...
      col.innerHTML = `
        ...
        <div class="card-text" text-center">Capital:${result[i].captial}</div>
    ...
    buttons.forEach((btn, index) => {
      btn.addEventListener("click", () => {
        ...
        let weatherApi= fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=62c67506850f9338d771d2f901e75c7c`)
